...
/**
 *  A Validator that ensures that a spinner has the correct selection
 */
public class SpinnerSelectionIdValidator implements Validator{
     ...
     */
    public SpinnerSelectionIdValidator(String requirementsMessage, long selectionId) {
    ...
    public boolean validate(View view) {
        ...
        return spinner.getSelectedItemId() == this.selectionId;
    }
